...
- 写作语言：中文
- 代码注释语言：保持源码原始语言
- 翻译：中文完成后，经用户明确确认后再翻译为英文
- **翻译时 repo 内部相对链接必须切换至对应语种版本**（中文版指向 `foo.md` → 英文版必须指向 `foo-en.md` 等对应英文版文件；详见 `index/style-guide.md` §13）
- 外部 URL（arxiv / GitHub / Hugging Face / Zhihu / 官网）保持不变
