...
- [从六个 TTS 服务栈到一个统一的 Serving 框架：SGLang Omni TTS 重构纪实](./sglang/sglang-omni/tts-refactor.md): how six model-local lifecycle stacks became shared contracts for engine bootstrap, state transport, reference caching, batch/streaming vocoders, and scheduler integration—and how Ming-Omni-TTS, ZONOS2, and a controlled Audar-TTS A/B validated the design.
