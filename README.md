...
- [When Six TTS Stacks Converge: Refactoring TTS Serving in SGLang Omni](./sglang/sglang-omni/tts-refactor.md): why similar autoregressive TTS pipelines still require different codebook, cache, and streaming semantics; how repeated serving mechanics became shared contracts; and how the refactor removed a net 2,840 non-test lines while making new-model onboarding smaller. Available in [Chinese version](./sglang/sglang-omni/tts-refactor-zh.md).
