...
- [From Six TTS Stacks to One Serving Framework: Refactoring TTS in SGLang Omni](./sglang/sglang-omni/tts-refactor.md): how six model-local lifecycle stacks became shared contracts for engine bootstrap, state transport, reference caching, batch/streaming vocoders, and scheduler integration—and how Ming-Omni-TTS, ZONOS2, and a controlled Audar-TTS A/B validated the design.
