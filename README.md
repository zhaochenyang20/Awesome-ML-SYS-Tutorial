...
- [When Duplication Reveals Structure: Rethinking What a TTS Serving Framework Should Own](./sglang/sglang-omni/tts-refactor.md): how SGLang Omni's TTS refactor extracted shared serving mechanics from six distinct TTS models, turning duplicated lifecycle code into framework contracts for bootstrap, state transport, caching, and vocoder scheduling.
